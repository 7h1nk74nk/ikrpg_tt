...
function onInit()
	...
	setGroupSort("Game (GM)", "2");
	setGroupSort("Combat (GM)", "3");
	setGroupSort("Token (GM)", "4");
	setGroupSort("House Rules (GM)", "5");
	...
	registerOption("SWPN", true, "Client", "Power: Show item used", "option_entry_cycler", 
	...
	registerOption("ESAV", false, "Combat (GM)", "Turn: Auto-roll saving throws", "option_entry_cycler", 
			{ labels = "On|NPC", values = "on|npc", baselabel = "Off", baseval = "off", default = "off" });
	...
	registerOption("TNAM", false, "Token (GM)", "Token: Show name", "option_entry_cycler", 
			...
			registerOption("HRMH", false, "House Rules (GM)", "NPC: Increase minion HP", "option_entry_cycler", 
			{ labels = "Level+5", values = "levelplus", baselabel = "Normal", baseval = "off", default = "off" });
	registerOption("HRSH", false, "House Rules (GM)", "NPC: Decrease standard HP", "option_entry_cycler", 
			{ labels = "3/4|2/3|1/2", values = "quarter|third|half", baselabel = "Full", baseval = "off", default = "off" });
	registerOption("HRID", false, "House Rules (GM)", "NPC: Increase standard damage", "option_entry_cycler", 
			{ labels = "1/2 Level", values = "halflevel", baselabel = "Normal", baseval = "off", default = "off" });
	registerOption("HRRD", false, "House Rules (GM)", "NPC: Reduce defenses", "option_entry_cycler", 
			{ labels = "-2", values = "two", baselabel = "Normal", baseval = "off", default = "off" });
	registerOption("HRFC", false, "House Rules (GM)", "Attack: Fumble/Crit Tables", "option_entry_cycler", 
